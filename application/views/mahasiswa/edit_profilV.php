  ...
  <div class="nav-tabs-custom">
    ...
    <div class="tab-content">
      <div class="active tab-pane" id="ubahprofil">
        ...
        <!-- form start -->
        <?php echo form_open_multipart('MahasiswaC/ubahProfil') ?>
        <div class="box-body">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="nim" id="nim" value="<?php echo $user['nim']; ?>" placeholder="Masukkan NIM" required>
        </div>
        <div class="form-group">
    ...
    <div class="tab-pane" id="ubahpassword">
      <!-- form start -->
      <form role="form" action="<?php echo site_url('MahasiswaC/resetPassword') ?>" method="POST">
        <div class="box-body">
          <input type="hidden" class="form-control" name="id_user" value="<?php echo $user['id_user']; ?>">
          <div class="form-group">
