...
<div class="login-box">
  ...
  <div class="login-box-body" style="background:rgba(255,255,255,0.4);">
    <p class="login-box-msg">Masukkan email dan kata sandi</p>

    <form class="login-form" action="<?php echo site_url('LoginC/signin'); ?>" method="POST">
       <?php 
      ...
      <div class="form-group has-feedback">
        <input type="email" name="email" class="form-control" placeholder="Email" autofocus required oninvalid="this.setCustomValidity('Email tidak boleh kosong')" oninput="setCustomValidity('')">
      ...
      <div class="form-group has-feedback">
        <input type="password" name="password" class="form-control" placeholder="Kata Sandi" required oninvalid="this.setCustomValidity('Password tidak boleh kosong')" oninput="setCustomValidity('')">
                <div class="form-control-feedback">
