...
<div class="col-xs-7">
  ...
  <div class="box box-primary" style="margin-top: 20px">
    ...
    <div class="box-body">
      ...
      <input type="hidden" class="form-control" name="id_jawaban_essay" value="<?php echo $nilai['id_jawaban_essay']; ?>">
...
<div class="col-xs-5">
  <div class="box box-primary" style="margin-top: 20px">
    <div class="box-header with-border">
      <center>
        <p>Nilai:</p>
        <input type="text" name="nilai" class="text-center" style="width: 70px;" required>
      </center>
    </div>
