...
?>
  ...
  <section class="content">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3>
                <?php
                $q= $this->db->query("SELECT id_user FROM user_role ur, user u WHERE ur.id_userrole=u.id_userrole AND ur.id_userrole=1")->num_rows();
                echo $q;
                ?>
              </h3>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3>
                <?php
                $q= $this->db->query("SELECT id_user FROM user_role ur, user u WHERE ur.id_userrole=u.id_userrole AND ur.id_userrole=2")->num_rows();
                echo $q;
                ?>
              </h3>
    ...
    <div class="row">
      <div class="col-xs-6">
        <!-- DONUT CHART -->
          <div class="box box-danger" style="border-top-color: #fff">
