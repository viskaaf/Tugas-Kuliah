            ...
            <table id="universitas" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><center><?php echo $value->nip; ?></center></td>
                  ...
                  <td><center>
                    ...
                    <a class="btn btn-info btn-xs tooltips" data-toggle="modal" data-target="#modal-lihat-<?php echo $value->id_user; ?>">
                      <span data-toggle="tooltip" data-original-title="Lihat Dosen" <i class="fa fa-eye"></i></span>
                    </a></center>
                  </td>
                </tr>
              <?php  endforeach; ?>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                  <h4 class="modal-title"><center>Detail Data Dosen</center></h4>
                </div>
