            ...
            <table id="universitas" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><center><?php echo $value->kode;?></center></td>
                  ...
                  <td><center>
                    ...
                    <?php }else { ?> 
                      <span class="label label-default"><?php echo $value->status_kelas; ?></span>
                    <?php } ?>
                  </center></td>
                  <td><center>
                    <?php if($value->status_kelas == 'Aktif') { ?> 
                      <a class="btn btn-danger btn-xs tooltips" data-toggle="modal" data-target="#modal-nonaktif-<?php echo $value->id_kelas;?>">
                        <span data-toggle="tooltip" data-original-title="Non-aktifkan Kelas" <i class="fa fa-dot-circle-o"></i></span>
                      </a>
                    <?php }else { ?>
                      <a class="btn btn-success btn-xs tooltips" data-toggle="modal" data-target="#modal-aktif-<?php echo $value->id_kelas;?>">
                        <span data-toggle="tooltip" data-original-title="Aktifkan Kelas" <i class="fa fa-dot-circle-o"></i></span>
                      </a>
                    <?php } ?>
                  </center>
                  </td>
        ...
        <div class="modal-dialog" style="width: 400px;">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <form id="form" class="form-horizontal" method="POST" action="<?php echo site_url('AdminC/ubahStatusTidakAktifKelas/'.$value->id_kelas); ?>">
          ...
          <div class="modal-dialog" style="width: 400px;">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <form id="form" class="form-horizontal" method="POST" action="<?php echo site_url('AdminC/ubahStatusAktifKelas/'.$value->id_kelas); ?>">
                  <div class="modal-body text-center" style="padding-top: 20px; padding-bottom: 20px;">
                    <input type="text" name="id_kelas" value="<?php echo $value->id_kelas;?>">
